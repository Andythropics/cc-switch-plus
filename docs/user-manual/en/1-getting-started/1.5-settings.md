...
On macOS, Skill storage and deployment are managed from the Skills area. The private Library is the only managed source, so there is no copy-mode or alternate-storage setting. See [Skills](../3-extensions/3.3-skills.md).
