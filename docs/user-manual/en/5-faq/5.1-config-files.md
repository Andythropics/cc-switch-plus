...
├── skills/           # Private Skill Library (macOS)
├── skill-import-backups/ # Managed update, removal, and migration recovery data
...
| library_skills | Portable Library identity, source metadata, and snapshots (macOS) |
| skill_repos | Portable Skill repository sources |
| project_workspaces | Device-local registered project identities (macOS) |
| skill_deployments | Device-local desired Claude/Codex deployments (macOS) |
| skill_activity | Device-local structured mutation history (macOS) |
